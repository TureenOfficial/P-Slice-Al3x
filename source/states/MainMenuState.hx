...
class MainMenuState extends MusicBeatState
{
	...
	public static var al3xVersion:String = '3.55 (PART TWO)';
	...
	override function create()
	{
		...
		var fnfVer:FlxText = new FlxText(0, FlxG.height - 18, FlxG.width, 'v${funkinVersion} (VS. Al3x v${al3xVersion}) (P-Slice ${pSliceVersion})', 12);
